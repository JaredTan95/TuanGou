...
public class JdbcadmininfoRepository implements admininfoRepository {
    ...
    private final static String VALIDATE_USER="SELECT adminId,adminAccount,adminPwd,adminRegDate,adminLastLoginDate FROM admininfo WHERE adminAccount=? AND adminPwd=?";
