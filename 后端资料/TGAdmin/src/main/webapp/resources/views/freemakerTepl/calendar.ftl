...
<head>
    ...
    <link rel="stylesheet" href="/resources/views/freemakerTepl/assets/css/fullcalendar.min.css" />
    <link rel="stylesheet" href="/resources/views/freemakerTepl/assets/css/fullcalendar.print.css" media='print' />
...
<body data-type="widgets">
    ...
    <script src="/resources/views/freemakerTepl/assets/js/moment.js"></script>
    <script src="/resources/views/freemakerTepl/assets/js/amazeui.min.js"></script>
    <script src="/resources/views/freemakerTepl/assets/js/fullcalendar.min.js"></script>
