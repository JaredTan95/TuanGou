...
public class JdbcConfig {
  ...
  @Bean
    public JdbcproductionCategoryRepository jdbcproductionCategoryRepository(JdbcTemplate jdbcTemplate){
      return new JdbcproductionCategoryRepository(jdbcTemplate);
  }
}
